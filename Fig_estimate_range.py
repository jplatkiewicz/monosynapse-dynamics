...
plt.plot(inject_range,inject_range,'--k')
plt.plot(nb_inject,injection_naive,'D-c', markerfacecolor='None', markeredgecolor='c')
plt.plot(nb_inject,injection_unbiased,'o-k')
plt.show()

# Represent the estimated injected synchrony distribution
FigTh.savefig('Fig_unbiased-vs-naive-estimate-range.eps')
