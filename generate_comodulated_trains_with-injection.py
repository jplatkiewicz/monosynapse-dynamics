...
Ntrial = 1000.#00#*5#*10*5
duration = 100000.*5#*100#*5#    # duration of the trial
time_step = 0.1            #-in (ms)
...
save('parameters_1.npy',np.array([Ntrial,duration,period,Fs]))
save('train_ref_1.npy',train_ref)
save('train_targ_1.npy',train_targ)